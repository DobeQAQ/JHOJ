...
import com.ljh.jhoj.OnlinejudgeApplication;
...
public class JedisTest {
    ...
    private static TestPointMapper testPointMapper = null;

    public static void main$(String[] args) {
        context = SpringApplication.run(OnlinejudgeApplication.class, args);
        testPointMapper = context.getBean(TestPointMapper.class);
        ...
        List<TestPointBean> testPointBeans = testPointMapper.getTestPointList(2);
