...
public class JudgeTest {
    ...
    public static void test(int id, String language) throws IOException {
        ...
        File sourceCodeFile = new File("src\\main\\java\\com\\ljh\\jhoj\\judge\\testcode\\Main.c");
        switch (language.toLowerCase()) {
            case "c":
                sourceCodeFile = new File("src\\main\\java\\com\\ljh\\jhoj\\judge\\testcode\\Main.c");
                break;
            case "c++":
                sourceCodeFile = new File("src\\main\\java\\com\\ljh\\jhoj\\judge\\testcode\\Main.cpp");
                break;
            case "java":
                sourceCodeFile = new File("src\\main\\java\\com\\ljh\\jhoj\\judge\\testcode\\Main.java");
                break;
            case "python2":
                sourceCodeFile = new File("src\\main\\java\\com\\ljh\\jhoj\\judge\\testcode\\Mainpy2.py");
                break;
            case "python3":
                sourceCodeFile = new File("src\\main\\java\\com\\ljh\\jhoj\\judge\\testcode\\Mainpy3.py");
                break;
        }
